...
const triangulo = calculcalcularAreaDePoligonoarAreaDePoligono("triangulo", 40, 2);
const cuadrado = ccalcularAreaDePoligonoalcularAreaDePoligono("cuadrado", 20, 20);
const rectangulo = ("rectangulo", 10, 15);
const cubo = ("cubo", 10, 20);
